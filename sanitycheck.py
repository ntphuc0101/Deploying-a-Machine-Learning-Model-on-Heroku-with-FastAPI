...
def run_sanity_check(test_dir):
    ...
    # assert path.isdir(test_dir), FAIL_COLOR+f"
    # No direcotry named {test_dir} found in {os.getcwd()}"
    print("This script will perform a sanity test to"
          + "ensure your code meets the criteria in the rubric.\n")
    print("Please enter the path to the file that contains"
    ...
    if not test_functions_for_get:
        ...
        print(
            ...
            This MUST test both the status code as well\
              as the contents of the request object.\n")
    ...
    print(
        ...
        and cannot guarantee the correctness of your code.")
    print(
        WARN_COLOR +
        "You should still check your work \
        against the rubric to ensure you meet the criteria.")
